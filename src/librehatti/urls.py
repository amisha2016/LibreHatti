...
#    url(r'^post/(?P<pk>\d+)/$', 'librehatti.dispatch_register.views.post_detail', name='post_detail'),
    ...
    url(r'^material_report', 'librehatti.reports.register.material_report'),
    ...
    url(r'^registered_users', 'librehatti.reports.register.registered_users'),
    ...
    url(r'^proforma_details/','librehatti.reports.previous_history.proforma_details'),
